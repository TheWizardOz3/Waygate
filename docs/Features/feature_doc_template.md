...
- **Business Impact:** {{Revenue, retention, engagement, or strategic value}}
- **Technical Impact:** {{Technical debt reduction, performance improvement, enablement of future features}}
...
|------|--------|-------------|
| Frontend | {{NEW | MODIFY | NONE}} | {{DESCRIPTION}} |
| Backend | {{NEW | MODIFY | NONE}} | {{DESCRIPTION}} |
| Database | {{NEW | MODIFY | NONE}} | {{DESCRIPTION}} |
| External Services | {{NEW | MODIFY | NONE}} | {{DESCRIPTION}} |
